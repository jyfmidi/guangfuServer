        ...
        <div class="container" data-reactid=".1tsg8migz5s.2.0.0">
            <div class="row" data-reactid=".1tsg8migz5s.2.0.0.0" >
                <div class="col-md-7" data-reactid=".1tsg8migz5s.2.0.0.0.0">
                    <div class="row" data-reactid=".1tsg8migz5s.2.0.0.0.0.0" >
                        <div class="col-md-8" data-reactid=".1tsg8migz5s.2.0.0.0.0.0.0">
                            <h1 class="display-4" data-reactid=".1tsg8migz5s.2.0.0.0.0.0.0.0">Artificial Intelligence</h1>
                            <p class="display-5" data-reactid=".1tsg8migz5s.2.0.0.0.0.0.0.1">光伏建站辅助决策专家</p>
                            <p class="lead" data-reactid=".1tsg8migz5s.2.0.0.0.0.0.0.1">海量数据支持，智能算法驱动</p>
                            <p class="lead" data-reactid=".1tsg8migz5s.2.0.0.0.0.0.0.1">我们为中国光伏产业的规划、投资提供专业决策参考</p>
                            <p class="lead" data-reactid=".1tsg8migz5s.2.0.0.0.0.0.0.1">
                                <a href="/combine.jsp" data-reactid=".1tsg8migz5s.0.1.0.1.1.1.0">
                                    <button type="button" class="btn btn-success-outline" data-reactid=".1tsg8migz5s.0.1.0.1.1.1.0.0">开始探索</button>
                                </a>
                            </p>
                        </div>
                ...
                <div class="col-md-5" data-reactid=".1tsg8migz5s.2.0.0.0.1" style="position: relative;">
                    <div class="col-md-12" data-reactid=".1tsg8migz5s.2.0.0.0.1" style="position: absolute; z-index: 2;">
                        <jsp:include page="static/mapGUI.jsp"/>
                    </div>
                    <div class="col-md-12" data-reactid=".1tsg8migz5s.2.0.0.0.1" style="left:0px; top:207px; position: absolute; z-index: 3;opacity: 0.8;">
                        <img src="image/ld.png" width="250px" height="200px">
                    </div>
                    <div class="col-md-12" data-reactid=".1tsg8migz5s.2.0.0.0.1" style="left:130px; top:74px; position: absolute; z-index: 4;opacity: 0.8;">
                        <img src="image/rt.png" width="250px" height="200px">
                    </div>
                    <div class="col-md-12" data-reactid=".1tsg8migz5s.2.0.0.0.1" style="left:151px; top:202px; position: absolute; z-index: 5;opacity: 0.8;">
                        <img src="image/rd.png" width="250px" height="200px">
                    </div>
                </div>
            </div>
        </div>

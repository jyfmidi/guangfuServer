...
<h2 id="details-judges" >Our Products</h2>

<div class="container sections judges">
    <div class="col-md-12" data-reactid=".1tsg8migz5s.2.0.0.0.1" style="left:0px; top:200px; position: absolute; z-index: 3;">
        <img src="../image/product.png" width="900px" height="1270px">
    </div>
</div>
</body>
</html>
